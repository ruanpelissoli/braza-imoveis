...
const HomePage: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col w-full px-10 relative justify-center items-start shadow shadow-black rounded-xl xl:h-[350px] border-black border-2 my-4 mx-auto font-sans bg-gradient-to-r from-[#ebc834] to-black overflow-hidden">
        <div className="flex flex-col mx-3 my-3 xl:space-x-12 xl:flex-row">
          {atualEx.slice(startIndex, endIndex).map((imovel: Imovel) => (
            <li
              key={imovel.id}
              className="flex my-2 justify-center border-solid border-black border-2 flex-col rounded-lg w-[200px] h-[300px] hover:shadow-xl hover:shadow-black bg-white"
            >
      ...
      <div className="flex h-[650px] mt-40 mb-40">
        <div className="w-1/2 h-full bg-[#333333] ml-10">
          <h2 className="text-white text-4xl font-sans my-10">Mobiliados:</h2>
          <div className="bg-yellow-500 flex flex-row justify-center items-center">
            {atualEx.slice(2, 5).map((imovel: Imovel) => (
              <li
                key={imovel.id}
                className="flex my-10 mx-10 justify-center border-solid border-black border-2 flex-col rounded-lg w-[200px] h-[300px] hover:shadow-xl hover:shadow-black bg-white"
              >
                <div className="w-full bg-black flex justify-center items-start flex-shrink-0 h-[15%] overflow-hidden">
                  <h2 className="text-[#acaa31] text-base uppercase overflow-hidden mt-0">
                    {imovel.title}
        ...
        <div className="w-1/2 h-full bg-yellow-500 mr-10">
