      ...
      <div className="flex flex-wrap items-center justify-center my-0 py-4 font-sans bg-mainUltraLighter">
        <div className="flex flex-col md:flex-row w-full md:w-fit justify-center items-center rounded-xl py-2 px-5 bg-black gap-3">
          <div className="text-black w-full p-2 rounded-xl">
            <label htmlFor="type" className="flex items-center justify-center text-white">
              Tipo:
            </label>
            <select
              id="type"
            ...
            <label htmlFor="bathrooms" className="flex items-center justify-center text-white">
              Banheiros:
            </label>
            <select
              id="bathrooms"
          ...
          <div className="text-black w-full p-2 rounded-xl">
            <label htmlFor="bedrooms" className="flex items-center justify-center text-white">
              Quartos:
            </label>
            <select
              id="bedrooms"
