...
const Filter: React.FC<{}> = () => {
  ...
  return (
    <>
      <div className='flex flex-wrap items-center justify-center my-0 py-4 font-sans bg-mainUltraLighter'>
        <div className='flex flex-wrap w-full justify-between rounded-xl py-2 px-5 bg-black max-w-6xl gap-3'>
          <div className='mb-1'>
            <label
              htmlFor='type'
              className='flex items-center mb-1 basis-full text-white'
            >
              Tipo:
            </label>
            <select
              ...
              className='flex flex-1 p-1 items-center w-36 min-w-0 rounded-lg'
            >
          ...
          <div className='text-black py-0 px-2.5 bg-mainLighter rounded-xl'>
            <div className='mb-1'>
              <label
                htmlFor='minSquareFoot'
                className='flex items-center mb-1 basis-full'
              >
                m² Mínimo:
              </label>
              <input
          ...
          <div className='text-black py-0 px-2.5 bg-main rounded-xl'>
            <div className='mb-1'>
              <label
                htmlFor='minPrice'
                className='flex items-center mb-1 basis-full'
          ...
          <div className='text-black py-0 px-2.5 bg-mainDarker rounded-xl'>
            <div className='mb-1'>
              <label
                htmlFor='stateId'
                className='flex items-center mb-1 basis-full'
              ...
              <select
                id='stateId'
                onChange={handleFilterChange}
                className='flex flex-1 p-1 items-center w-36 min-w-0 rounded-lg text-black'
              >
                <option value=''>Qualquer</option>
          ...
          <button
            className='bg-white text-black py-1 px-3.5 rounded-xl cursor-pointer border-0 hover:text-[#fcf94d] hover:bg-black transition-color duration-500'
